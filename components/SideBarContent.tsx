	...
	return (
		<div>
			{dashboardData?.map(item => {
				if (collapsed) {
					return (
						<div className="-1 pb-8 border-b-2 mt-1 hover:bg-slate-800 cursor-pointer rounded-md">
				...
				return (
					<div
						className={cn({
							"p-1 pb-8 border-b-2 mt-1 hover:bg-slate-800 cursor-pointer rounded-md": true,
